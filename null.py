...
async def repos(event):
    await event.reply(
            REPO_TEXT,
            buttons=[
                [Button.url("Click Here", "https://github.com/ShikariBaaZ/Whisper_Robot")]
                ]
            )
...
null_txt = 'By github.com/ShikariBaaZ | t.me/The_Shikarii\n'
null_txt += 'Any questions? Say it at t.me/ShikariSupportNetwork\n'
null_txt += f'{NULLBOT_NAME} started! Developed and Maintaned by ✨Shikarii✨\n'
print(null_txt)
